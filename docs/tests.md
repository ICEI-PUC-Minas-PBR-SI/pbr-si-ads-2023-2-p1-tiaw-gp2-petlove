...
Neste projeto serão realizados dois tipos de testes, sendo eles:
 ...
 - O **Teste de Software**, que utiliza uma abordagemA de caixa preta, e tem por objetivo verificar a conformidade do software com os requisitos funcionais e não funcionais do sistema.

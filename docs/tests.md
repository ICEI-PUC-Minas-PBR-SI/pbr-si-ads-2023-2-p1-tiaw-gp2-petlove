...
Neste projeto serão realizados dois tipos de testes:
 ...
 - O **Test de Softwar**, que utiliza uma abordaem de caixa preta, e tem por bjetivo verficar a conformidae do ofware co os requsitos funionais e não funcionais do siste

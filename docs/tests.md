...
Neste projeto serão realizados dois tipos de testes:
 ...
 - O **Teste de Software**, que utiliza uma abordagem de caixa preta, e tem por objetivo verificar a conformidade do software com os requtsunoais e não funcionais do siste
